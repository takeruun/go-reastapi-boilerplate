...
func TestSignIn(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		mockUserRepository.EXPECT().FindByEmail(email).Return(&expectedUser, err)
...
func TestSignUp(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		mockUserRepository.EXPECT().Create(&entity.User{Email: email, HashPassword: hashPassword, Name: name}).Return(&expectedUser, err)
		mockSessionService.EXPECT().SaveSession(gomock.Any(), "userId", expectedUser.ID)
